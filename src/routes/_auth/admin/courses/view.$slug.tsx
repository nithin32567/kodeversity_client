...
export const Route = createFileRoute("/_auth/admin/courses/view/$slug")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      {
        name: "description",
        content: `Learning workspace for ${loaderData?.course?.title ?? "Course"}.`,
      },
    ],
  }),
  component: LearnPage,
...
function ActionTile({
  ...
  return (
    ...
    >
      ...
      {to ? (
        <Link to={to as any} params={params as any} className={btnClass}>
