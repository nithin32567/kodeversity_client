...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Helper to check if client coordinate is inside the Hero boundary
    function isInsideHero(clientY: number): boolean {
    ...
    function handleTouchStart(e: TouchEvent) {
      ...
      for (let i = 0; i < touches.length; i++) {
        if (isInsideHero(touches[i].clientY) || isInsideFooter(touches[i].clientY)) continue;
