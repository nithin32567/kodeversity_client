...
export function Topbar() {
  ...
  return (
    <header className="flex flex-wrap items-center gap-3 px-4 pt-4 pb-4 sm:px-5 lg:px-6 lg:pt-5">
      ...
      <div className="min-w-0 flex-1 sm:flex-none">
        <h1 className="text-[22px] font-semibold tracking-tight leading-tight">Admin Dashboard</h1>
      ...
      <div className="flex items-center gap-2 shrink-0 ml-auto">
        ...
        <button
          className="hidden sm:inline-flex ml-2 items-center gap-1.5 h-10 px-4 rounded-md text-sm font-medium text-white shadow-lg shadow-indigo-500/25"
