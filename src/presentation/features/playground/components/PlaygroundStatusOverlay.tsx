      ...
      <div className="relative w-full max-w-md">
        ...
        <div
          className={`relative rounded-2xl border p-8 shadow-2xl text-center ${
            isError ? "bg-card border-destructive/30" : "bg-card border-border"
          }`}
        >
          {}
          <div
          ...
          {}
          <h3 className="text-lg font-bold text-foreground mb-1">{phaseInfo.label}</h3>
              ...
              {(["GENERATING_ID", "CREATING", "POLLING", "CONNECTING", "READY"] as const).map(
                (step, i) => {
                  ...
                  const isCurrent =
                    ...
                    currentProgress <
                      getPhaseInfo(
                        (["GENERATING_ID", "CREATING", "POLLING", "CONNECTING", "READY"] as const)[
                          i + 1
                        ] ?? "READY",
                      ).progress;
